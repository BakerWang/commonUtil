package com.cdeledu.application.access;
...
public class AccessControl {
	...
	/*--------------------------常量 start-------------------------------*/
	/** 访问控制信息文件路径 */
	public final static String ACCESS_PATH = "access/access.xml";
	...
	/** IP区间名单列表 */
	private List<Span> ipSections = new ArrayList<Span>();
	/** 用户组 */
	private Set<String> groups = new HashSet<String>();
	/** 用户列表 */
	private Map<String, Connector> users = new HashMap<String, Connector>();
	...
	public void init(String pathBaseClassLoader) {
		Document doc = null;
		try {
			doc = XmlUtils.readDoc(ACCESS_PATH);
