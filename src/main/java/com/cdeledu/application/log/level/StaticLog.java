package com.cdeledu.application.log.level;

import com.cdeledu.application.log.Log;
import com.cdeledu.application.log.LogFactory;

/**
 * @类描述: 静态日志类，用于在不引入日志对象的情况下打印日志
 * @创建者: 独泪了无痕
 * @创建日期: 2016年1月21日 下午7:43:01
 * @版本: V1.0
 * @since: JDK 1.7
 */
public class StaticLog {
	...
	public static void warn(Throwable e, String format, Object... arguments) {
		warn(LogFactory.indirectGet(), e, String.format(format, arguments));
	}
	...
	public static void warn(Log log, Throwable e, String format, Object... arguments) {
		log.warn(String.format(format, arguments), e);
	}
	...
	public static void error(Throwable e, String format, Object... arguments) {
		error(LogFactory.indirectGet(), e, String.format(format, arguments));
	}
	...
	public static void error(Log log, Throwable e, String format, Object... arguments) {
		log.error(String.format(format, arguments), e);
	}
