...
public class CrawlMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					propsMap = PropertyHelperUtils.getPropertyMap(BASE);
					more_propsMap = PropertyHelperUtils.getPropertyMap(MORE_TOOLS);
					network_propsMap = PropertyHelperUtils.getPropertyMap(NETWORK_TOOLS);
