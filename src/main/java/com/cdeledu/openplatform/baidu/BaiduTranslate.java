...
import com.cdeledu.openplatform.baidu.util.constants.BaiduLangType;
import com.cdeledu.openplatform.baidu.util.constants.ResultStatus;
...
class BaiduTranslate {
	...
	private static List<String> parse(String content, String from, String to) {
		...
		String _result = HttpURLConnHelper.sendGetRequest(realUrl);
